...
* [Some basics of state-space models](https://www.youtube.com/watch?v=X-7rgesJaGM) - Note, state-space models are just a fancy name for recurrent networks that are linear through time.
